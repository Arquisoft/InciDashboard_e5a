...
//		String data = "{ \"identificador\": \"usuario\", \"password\": \"contraUsuario\", \"nombre\": \"nieve\","
//				+ " \"descripcion\": \"atasco en A6 por nevadas\", \"localizacion\": \"32.23&23.23\", "
...
//				+ "\"propiedades\": [{\"P1\" : \"V1\" },{ \"P2\" : \"V2\"}]}";
		...
		String identificador = getString(data, obj, "identificador");
	    	...
	    	Set<String> etiquetas = arrayEtiquetas != null ? new HashSet<String>(Arrays.asList(arrayEtiquetas)) : new HashSet<String>();
	    	...
	    	if(identificador != null && user != null) {
	    		incidence = null;//new Incidence(user, nombre, descripcion, localizacion, etiquetas, propiedades);
